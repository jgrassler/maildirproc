...
This is an extension to http://joel.rosdahl.net/maildirproc/

It filters email in an IMAP folder according to a set of sorting rules defined
by a snippet of Python code. It provides hooks that let your program access the
emails' headers along with functions for moving, copying  and forwarding.
"""
...
from maildirproc.processor.imap import ImapProcessor
...
def main():
    ...
    parser = OptionParser(
        ...
        description=(
            ...
            " See http://joel.rosdahl.net/maildirproc/ for more information."))
    parser.add_option(
        "--auto-reload-rcfile",
        action="store_true",
        default=False,
    ...
    parser.add_option(
        ...
        help=(
            ...
            " maildirproc will scan the folders in regular intervals (set these"
    ...
    for opt in ("auto_reload_rcfile", "certfile", "dry_run", "host", "port",
                "user", "use_ssl", "verbosity"):
